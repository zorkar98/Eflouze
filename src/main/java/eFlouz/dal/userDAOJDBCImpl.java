...
public class userDAOJDBCImpl  {
	...
	public void ajouterUser(User userAjoute) throws Exception{
		...
		//Verifie si des lignes ont �t� ajout�es, SI OUI -> genere KEY identity et ajoute � l'user ins�r�
	...
	public int selectByPseudoAndEmail(String  pseudo, String email) throws Exception {
		...
		//VERIFIER si l'email ou/et le pseudo est/sont trouv�(s)
		...
		// SI presence en base = 0 -> rien trouv�
